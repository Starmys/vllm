...
class Phi3MoEAttention(nn.Module):
    ...
    def __init__(self,
        ...
        if isinstance(
            ...
            print_warning_once(
                "For Phi3MoE FP8 quantization, we currently do not quantize "
...
class Phi3MoEDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = Phi3MoEAttention(
            ...
            quant_config=quant_config)
        self.block_sparse_moe = Phi3MoEBlock(
...
class Phi3MoEForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.config = config
        self.model = Phi3MoEModel(config,
                                  quant_config,
